...
function init() {
  ...
  var AppRouter = Backbone.Router.extend({
    ...
    _homeSlide: function _homeSlide() {
      this._goToSlide(0);
    },
    _transportGoingSlide: function _transportGoingSlide() {
      this._goToSlide(1);
    },
    _churchSlide: function _churchSlide() {
      this._goToSlide(2);
    },
    _banquetSlide: function _banquetSlide() {
      this._goToSlide(3);
    },
    _transportReturnSlide: function _transportReturnSlide() {
      this._goToSlide(4);
    },
    _accomodationSlide: function _accomodationSlide() {
      this._goToSlide(5);
    },
    _tripSlide: function _tripSlide() {
      this._goToSlide(6);
    },
    _contactSlide: function _contactSlide() {
      this._goToSlide(7);
    },

    _goToSlide: function _goToSlide(slideNumber) {
      if (slideNumber >= 0) {
        if (Carousel) {
...
module.exports = DefaultSlideView.extend({
  ...
  _focusInput: function _focusInput(ev) {
...
module.exports = Backbone.View.extend({
  ...
  _createMenu: function _createMenu() {
    ...
    this.collection.each(function (item) {
      $menu.append($('<li>').append($('<a>').addClass('Navigation-menuDropdownItem js-menuButton').click(function () {
        this.model.set('visible', false);
        this._hideMenu();
      }.bind(this)).html(item.get('key')).attr('href', '#/' + item.get('key'))));
    }, this);
...
module.exports = {
  ...
  "form": {
    "email": "*Your email",
    "phone": "*Your phone",
    "song": "Your favourite song for the wedding",
  ...
  "transport-going": {
    ...
    "title": "Transport",
    "sub-title": "departure",
    "desc": "Everything will start at the <a class='Color Color--link' href='/#/church'>church</a>, but to arrive there, you will need transportation. We have a bus route that will cover several places; please select your pickup point:",
    "placeholder": "Select a place"
  },
  "church": {
    "key": "church",
    "title": "Church",
    "desc": "Our first stop will be the ceremony, which will take place at <a class='Color Color--link' href='http://corpuschristi.archimadrid.es/' target='_blank'>Santísimo Corpus Christi</a> church at 6 p.m. It is located at <a class='Color Color--link' href='https://goo.gl/UlFTUn' target='_blank'>Camino de Perales 4, Las Rozas, Madrid</a>. <br/><br/><span class='Text Text-disclaimer Color'>*Don't be late because Laura is very punctual!</span>",
    "comment": "Long live the bride & groom!"
  },
  "banquet": {
    "key": "banquet",
    "title": "Banquet",
    "desc": "Afterwards we will enjoy good music, food, and drinks at <a class='Color Color--link' href='https://goo.gl/Dt6WXG' target='_blank'>Los Arcos de Fuentepizarro</a>. This estate is located at <a href='https://goo.gl/SnPMNI' class='Color Color--link' target='_blank'>Ctra Guadarrama al Escorial, km 3.400, San Lorenzo del Escorial, Madrid</a>.<br/><br/><span class='Text-disclaimer Color'>*If you took the bus, it will bring you there, too.</span>",
  ...
  "transport-return": {
    ...
    "title": "Transport",
    "sub-title": "Return",
    "desc": "The party will finish between 5 a.m. and 6 a.m. But if you wish to leave sooner, there will also be buses at 1 a.m. (after starting the party), and 3.30 a.m. Just like on your way here, the bus will stop at several places; check them out!",
    "placeholder": "Select a place"
  },
  "accomodation": {
    "key": "accomodation",
    "title": "Accomodations",
    "desc": "If you would like sleep a little bit after the party, we recommend some places in El Escorial and in Madrid. Please check them out:",
    "placeholder": "Select a city"
  },
  "honeymoon": {
    "key": "honeymoon",
    "title": "Honeymoon",
    "desc": "We are going to New Zealand! And we would like to visit several points of interest. We have the flights and two backpacks; would you like to help us with our route? <br/><br/>Below you will find a list of activities we would like to enjoy in this country. It will be the first time we visit it (and we think it will be the last—it is the antipode of Spain!). </br></br> If you are interested in helping us with any of them, please add your email in the field after this paragraph. We will get back to you with instructions. <br/><br/><span class='Text-disclaimer Color--dark'>*We have designed a possible route—<a class='Color Color--linkAlternative' href='https://team.carto.com/u/xavijam/builder/93f4baea-9ec3-11e6-b132-0ef24382571b/embed' target='_blank'>take a look</a>.</span>",
    "expense": "expense",
    "leisure": "leisure",
    ...
    "items": {
      "renting": {
        "title": "🚐 · Rent a van",
        "desc": "We would like to visit the whole country (both islands), so we need transportation.",
      ...
      "coromandel": {
        "title": "🚤 · Kayaking at Coromandel reserve",
      ...
      "petrol": {
        "title": "⛽️ · Petrol",
        "desc": "According to our plans, we travel around 2,600 km in the south island and 900 km in the north island."
      }
    }
  },
  "contact": {
    "key": "confirmation",
    "title": "Confirmation",
    "desc": "Time to confirm your attendance! Add as many attendees as you wish, specifying the name and if s/he has an allergy or is vegetarian.",
    "attendees": "attendees",
    "bus-info": "buses",
    "your-info": "details",
    "other-contact": "Or if you prefer to call or write us directly.",
    "name": "Name",
    "placeholder-transport-going": "Do you need transportation to get there?",
    "placeholder-transport-return": "Do you need transportation for your return?",
    "add-attendee": "Add attendee",
    "we-dont-need": "We don't need",
    "allergy": {
      "placeholder": "Allergy/Other",
      "nothing": "None",
      "nuts": "Nuts",
      "lactose": "Lactose",
      "egg": "Egg",
...
module.exports = {
  ...
  "transport-going": {
    ...
    "title": "Transporte",
    "sub-title": "ida",
    "desc": "Todo empezará en la <a class='Color Color--link' href='/#/iglesia'>iglesia</a>, pero para llegar allí necesitarás un medio de transporte. Si vas en coche no hay problema, pero sino tenemos una ruta de autobús que pasará por varios sitios, busca tu punto de salida más cercano:",
  ...
  "banquet": {
    ...
    "comment": "¡Que se besen!"
  },
  "transport-return": {
    "key": "transporte-vuelta",
    "title": "Transporte",
    "sub-title": "vuelta",
    "desc": "La fiesta acabará entre las 5 y las 6 de la mañana. Pondremos autobuses a la 1:00 (un rato después de empezar el baile), a las 3:30 y al finalizar.<br/>Como en la ida, dispondréis de una ruta de autobús que pasará por varios lugares, busca tu punto de llegada más cercano:",
    "placeholder": "Selecciona un lugar"
  },
  "accomodation": {
    "key": "hoteles",
    "title": "Hoteles",
    "desc": "Si quieres dormir algo después de la fiesta, nosotros te recomendamos unos cuantos en el Escorial y en Madrid. ¿Dónde te interesa?:",
    "placeholder": "Selecciona una ciudad"
  },
  "honeymoon": {
    "key": "viaje",
    "title": "Viaje",
    "desc": "Nos vamos a Nueva Zelanda y queremos visitar muchos lugares. Tenemos los billetes de avión y las mochilas, ¿nos ayudáis a elegir nuestra ruta? <br/><br/>Aquí debajo encontrarás un listado de actividades que nos encantaría hacer en este páis, ya que será la primera vez que lo visitemos (y creemos que la última, ¡son las antípodas de España!). </br></br> Si estás interesado en ayudarnos con alguna/s de ellas, simplemente añade y envía tu email a continuación y te contestaremos con las instrucciones a seguir. <br/><br/><span class='Text-disclaimer Color--dark'>*Hemos pensado en un posible recorrido, <a class='Color Color--linkAlternative' href='https://team.carto.com/u/xavijam/builder/93f4baea-9ec3-11e6-b132-0ef24382571b/embed' target='_blank'>échale un vistazo</a>.</span>",
    "expense": "gasto",
    "leisure": "ocio",
    "send": "Enviar",
    "sending": "Enviando...",
...
var __templateData = Handlebars.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return ((stack1 = (helpers.ifCond || (depth0 && depth0.ifCond) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.category : depth0),"==",(depths[1] != null ? depths[1].selectedCategory : depths[1]),{"name":"ifCond","hash":{},"fn":container.program(2, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "");
...
var __templateData = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"Slide-content Slide-content--centered\">\n  <div class=\"Slide-contentIcon\">\n    <div class=\"Animation js-animation\">\n      <span class=\"Animation-comment Animation-commentColorYellowish\">"
...
var __templateData = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"Slide-content Slide-content--centered\">\n  <div class=\"Slide-contentIcon\">\n    <div class=\"Animation js-animation\">\n      <span class=\"Animation-comment Animation-comment--right Animation-commentColorGreenish\">"
...
var __templateData = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
    ...
    + container.escapeExpression((helpers.t || (depth0 && depth0.t) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),"contact.add-attendee",{"name":"t","hash":{},"data":data}))
    + "\n  </button>\n";
},"3":function(container,depth0,helpers,partials,data) {
...
var __templateData = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
    ...
    + container.escapeExpression((helpers.t || (depth0 && depth0.t) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),"form.send",{"name":"t","hash":{},"data":data}))
    + "\n  </button>\n";
},"5":function(container,depth0,helpers,partials,data) {
    return "  <button type=\"button\" class=\"Button Button--disabled\">\n    "
    + container.escapeExpression((helpers.t || (depth0 && depth0.t) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),"form.sending",{"name":"t","hash":{},"data":data}))
    + "\n  </button>\n";
},"7":function(container,depth0,helpers,partials,data) {
    return "  <button type=\"submit\" class=\"Button Button--success\">\n    "
    + container.escapeExpression((helpers.t || (depth0 && depth0.t) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),"form.sent",{"name":"t","hash":{},"data":data}))
    + "\n  </button>\n";
},"9":function(container,depth0,helpers,partials,data) {
    return "  <button type=\"submit\" class=\"Button Button--error\">\n    "
    + container.escapeExpression((helpers.t || (depth0 && depth0.t) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),"form.error",{"name":"t","hash":{},"data":data}))
    + "\n  </button>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
...
var __templateData = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"Form-fieldset\">\n  <div class=\"Form-field\">\n    <input type=\"email\" name=\"email\" class=\"Form-input Form-input--m Form-input--centered js-textInput\" placeholder=\""
...
var __templateData = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "      <li class=\"pure-u-1 pure-u-sm-1-2 pure-u-md-1-2 pure-u-lg-1-3\">\n        <div class=\"l-box\">\n          <div class=\"TravelList-item\">\n            <div class=\"TravelList-itemImage\">\n              <img class=\"pure-img\" src=\""
    ...
    return "                <a href=\""
    + container.escapeExpression((helpers.t || (depth0 && depth0.t) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.wikipediaURL : depth0),{"name":"t","hash":{},"data":data}))
    + "\" class=\"TravelList-itemWikipedia\" target=\"_blank\">\n                  <i class=\" fa fa-wikipedia-w\"></i>\n                </a>\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "                <a href=\""
    + container.escapeExpression((helpers.t || (depth0 && depth0.t) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.itemURL : depth0),{"name":"t","hash":{},"data":data}))
...
var __templateData = Handlebars.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.slides : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "");
},"useData":true,"useDepths":true});
if (typeof define === 'function' && define.amd) {
  define([], function() {
    return __templateData;
