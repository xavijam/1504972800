...
module.exports = {
  ...
  "honeymoon": {
    "key": "honeymoon",
    "title": "Honeymoon",
    "desc": "We are going to New Zealand! And we would like to visit several points of interest. We have the flights and two backpacks; would you like to help us with our route? <br/><br/>Below you will find a list of activities we would like to enjoy in this country. It will be the first time we visit it (and we think it will be the last—it is the antipode of Spain!). </br></br> If you are interested in helping us with any of them, please add your email in the field at the bottom of the list. We will get back to you with instructions. <br/><br/><span class='Text-disclaimer Color--dark'>*We have designed a possible route—<a class='Color Color--linkAlternative' href='https://team.carto.com/u/xavijam/builder/93f4baea-9ec3-11e6-b132-0ef24382571b/embed' target='_blank'>take a look</a>.</span>",
    "expense": "expense",
    "leisure": "leisure",
...
module.exports = {
  ...
  "honeymoon": {
    "key": "viaje",
    "title": "Viaje",
    "desc": "Nos vamos a Nueva Zelanda y queremos visitar muchos lugares. Tenemos los billetes de avión y las mochilas, ¿nos ayudáis a elegir nuestra ruta? <br/><br/>Aquí debajo encontrarás un listado de actividades que nos encantaría hacer en este páis, ya que será la primera vez que lo visitemos (y creemos que la última, ¡son las antípodas de España!). </br></br> Si estás interesado en ayudarnos con alguna/s de ellas, simplemente añade y envía tu email después de la lista y te contestaremos con las instrucciones a seguir. <br/><br/><span class='Text-disclaimer Color--dark'>*Hemos pensado en un posible recorrido, <a class='Color Color--linkAlternative' href='https://team.carto.com/u/xavijam/builder/93f4baea-9ec3-11e6-b132-0ef24382571b/embed' target='_blank'>échale un vistazo</a>.</span>",
    "expense": "gasto",
    "leisure": "ocio",
    "send": "Enviar",
    "sending": "Enviando...",
