...
module.exports = Backbone.View.extend({
  ...
  _createMenu: function _createMenu() {
    ...
    this.collection.each(function (item) {
      $menu.append($('<li>').append($('<a>').addClass('Navigation-menuDropdownItem').html(item.get('key')).attr('href', item.get('key')).attr('data', 'slide-url')));
    });
...
module.exports = {
  ...
  "transport-going": {
    ...
    "title": "Transport",
    "sub-title": "going",
    "desc": "Everything will start at the <a class='Color Color--link' href='church' data='slide-url'>church</a>, but in order to arrive there, you will need a transport. We have two bus routes that will cover several places, check your closer point:",
...
module.exports = {
  ...
  "transport-going": {
    ...
    "title": "Transporte",
    "sub-title": "ida",
    "desc": "Todo empezará en la <a class='Color Color--link' href='iglesia' data='slide-url'>iglesia</a>, pero para llegar allí necesitarás un medio de transporte. Si vas en coche no hay problema, pero sino tenemos dos rutas de autobús que pasan por varios sitios, busca tu punto de salida más cercano:",
